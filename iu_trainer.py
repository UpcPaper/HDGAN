...
class DebuggerBase:
    def __init__(self, args):
        ...
        self.train_data_loader = self._init_data_loader(split='train', transform=self.train_transform, shuffle=False)
...
class LSTMDebugger(DebuggerBase):
    ...
    #         for sentence_index in range(captions.shape[1]):  # 是s_max=6 一个caption里有六句话
    #
    ...
    def _epoch_train(self):
        ...
        for i, (images1, images2, captions, prob, image_id) in enumerate(progress_bar):
        ...
        return batch_tag_loss, stop_loss, word_loss, loss
...
if __name__ == '__main__':
    ...
    Data Argument
    """
    RESUME_MODEL_PATH = './models/2023-10-20 11:03/train_best.pth.tar'
