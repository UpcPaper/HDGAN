...
from utils.datasets_mimic import get_loader as get_loader_t
...
class AdversarialBase:
    ...
    def loss_with_reward(self, prediction, x, rewards):
        embedding = nn.Embedding(9022, 9022)
        prediction = embedding(prediction.long())
        x1 = x.contiguous().view([-1, 1]).long()
        one_hot = torch.Tensor(x1.shape[0], 9022).cuda()
        one_hot.zero_()
        x2 = one_hot.scatter_(1, x1, 1)
        pred1 = prediction.view([-1, 9022])
...
if __name__ == '__main__':
    ...
    Data Argument
    """
    parser.add_argument('--data_dir', type=str, default='/home/upc/sxx/Data/mimic_cxr/annotation.json',
    ...
    parser.add_argument('--load_disc_model_path', type=str, default='./report_disc_models/v4_mimic/disc_train_best_loss.pth.tar',
                        help='The path of loaded disc model')
    parser.add_argument('--load_discs_model_path', type=str,
                        default='./report_discs_models/v4_mimic/discs_train_best_loss.pth.tar',
                        help='The path of loaded discs model')
    parser.add_argument('--disc_saved_model_name', type=str, default='./report_disc_models/v4_mimic/',
                        help='The name of saved model')
    parser.add_argument('--discs_saved_model_name', type=str, default='./report_discs_models/v4_mimic/',
                        help='The name of saved model')



    # Path Argument
    parser.add_argument('--vocab_path', type=str, default='./data/new_data/vocab_mimic.pkl',
    ...
    parser.add_argument('--load_model_path', type=str,
                        default='./report_v4_models/v4_mimic/train_best_loss.pth.tar',
                        help='The path of loaded model')
    parser.add_argument('--saved_model_name', type=str, default='./report_v4_models/v4_mimic/',
                        help='The name of saved model')
    ...
    parser.add_argument('--load_semantic_model_path', type=str, default="./report_v4_models/v4_mimic/train_best_loss.pth.tar")
