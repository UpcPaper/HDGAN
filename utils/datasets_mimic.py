...
class ChestXrayDataSet(Dataset):
    def __init__(self,
        ...
        self.ann_path = '/home/upc/sxx/Data/mimic_cxr/annotation.json'
    ...
    def __getitem__(self, idx):
        ...
        DATA_PATH = "/home/upc/sxx/Data/mimic_cxr/images/"
        image1 = Image.open(os.path.join(DATA_PATH, image_path[0])).convert('RGB')
        image2 = Image.open(os.path.join(DATA_PATH, image_path[0])).convert('RGB')
